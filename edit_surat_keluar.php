<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['tujuan_surat'] == "" || $_REQUEST['isi'] == ""
                || $_REQUEST['batas_waktu'] == "" || $_REQUEST['tgl_surat'] == ""){
                ...
                $atujuan_surat = $_REQUEST['tujuan_surat'];
                $isi = $_REQUEST['isi'];
                ...
                if(!preg_match("/^[0-9]*$/", $no_agenda)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tujuan_surat)){
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,no_surat,tujuan_surat,isi,tgl_surat,
                                                                    tgl_diterima,file,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$tujuan_surat','$isi','$tgl_surat','$batas_waktu','$nfile','$id_user')");
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper pik-purple darken-1">
                            <ul class="left">
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="input-field col s6">
                            ...
                            <input id="tujuan_surat" type="text" class="validate" name="tujuan_surat" required>
                                <?php
                                    if(isset($_SESSION['tujuan_surat'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$tujuan_surat.'</div>';
                        ...
                        <div class="input-field col s6">
                            ...
                            <!-- <input type="text" placeholder="Tanggal Diterima" onfocus="(this.type='date')" onblur="(this.type='text')" required> -->
                                <?php
                                    if(isset($_SESSION['batas_waktu'])){
                                        $batas_waktu = $_SESSION['batas_waktu'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$batas_waktu.'</div>';
                                        unset($_SESSION['batas_waktu']);
                                    }
                                ?>  
                            <label for="batas_waktu">Diterima Tanggal</label>
                        </div>
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" required>
                                <?php
                                    if(isset($_SESSION['tgl_surat'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$tgl_surat.'</div>';
                        ...
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                ...
                                if(isset($_SESSION['no_agenda'])){
                                    ...
                                    echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$no_agenda.'</div>';
                            ...
                            <input id="no_surat" type="text" class="validate" name="no_surat" required>
                                <?php
                                    if(isset($_SESSION['no_surat'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$no_surat.'</div>';
                                        unset($_SESSION['no_surat']);
                                    }
                                    if(isset($_SESSION['errDup'])){
                                        $errDup = $_SESSION['errDup'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errDup.'</div>';
                            ...
                            <textarea id="isi" class="materialize-textarea validate" name="isi" required></textarea>
                                <?php
                                    if(isset($_SESSION['isi'])){
                                        $isi = $_SESSION['isi'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$isi.'</div>';
                                        unset($_SESSION['isi']);
                                    }
                                ?>
                                    ...
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar surat masuk">
                                        <?php
                                            if(isset($_SESSION['errSize'])){
                                                ...
                                                echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errSize.'</div>';
                                                unset($_SESSION['errSize']);
                                            }
                                            if(isset($_SESSION['errFormat'])){
                                                $errFormat = $_SESSION['errFormat'];
                                                echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errFormat.'</div>';
