...
<head>
    ...
    <title>E-Arsip SMK Muhammadiyah 2</title>
    ...
    <style type="text/css">
        ...
        .bg::before {
            content: '';
            background-image: url('./asset/img/bd.jpg');
...
<!-- Body START -->
<body class="pink-purple lighten-3 bg">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">E-Arsip SMK Muhammadiyah 2 Malang</h5>
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                <a class="btn-large waves-effect waves-light pink col s11" href="" style="margin: 20px 0 0 5px;"><i class="material-icons md-24">arrow_back</i> Kembali ke login form</a></div>';
                            } else {
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        <div class="row">
                            <?php
                                if(isset($_SESSION['errLog'])){
                                    ...
                                    echo '<div id="alert-message" class="error greylighten-5"><div class="center"><i class="material-icons">error_outline</i> <strong>LOGIN GAGAL!</strong></div>
                                    '.$errLog.'</div>';
                                    unset($_SESSION['errLog']);
                                }
                                if(isset($_SESSION['err'])){
                                    $err = $_SESSION['err'];
                                    echo '<div id="alert-message" class="error greylighten-5"><div class="center"><i class="material-icons">error_outline</i> <strong>ERROR!</strong></div>
                                    '.$err.'</div>';
                                    unset($_SESSION['err']);
                                }
                            ?>
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light pink col s12" name="submit">LOGIN</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
