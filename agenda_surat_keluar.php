        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                echo '
                    ...
                    <div class="disp hidd">';
                    $query2 = mysqli_query($config, "SELECT institusi, nama, alamat, website, email, logo FROM tbl_instansi");
                    list($institusi, $nama, $alamat, $website, $email, $logo) = mysqli_fetch_array($query2);
                            echo '<img class="logodisp" src="./asset/img/'.$logo.'"/>';

                            echo '<a style="font-size:20px; font-family: Times New Roman; color:#000;"><b>'.$institusi.'</b></a><br/>';

                            echo '<a style="font-size:15px; font-family: Times New Roman; color:#000;" id="nama"><b>'.$nama.'</b></a><br/>';

                            echo '<a style="font-size:18px; font-family: Times New Roman; color:#000;">'.$alamat.'</a><br/>';
                            echo '<a style="font-size:15px; font-family: Times New Roman; color:#000;"><b>email:</a> <a style="color:purple; font-size:15px"><u>'.$email.'</u></b></a>&nbsp;';
                            echo '<a style="font-size:15px; font-family: Times New Roman; color:#000;"><b>website: </a><a style="color:purple; font-size:135x"><u>'.$website.'</u></a> </b><br/>';
            ...
            echo '
                ...
                <div class="row jarak-form black-text">
                    <form class="col s12" method="post" action="">
                        ...
                        <div class="col s6">
                            <button type="submit" name="submit" class="btn-large  waves-effect waves-light"> TAMPILKAN <i class="material-icons">visibility</i></button>
                        </div>
                    </form>
                </div>
                <!-- Row form END -->';
