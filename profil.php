                                ...
                                if(strlen($username) < 5){
                                    ...
                                    if(strlen($password) < 5){
                                        ...
                                        if(mysqli_num_rows($query) > 0){
                                            $do = mysqli_query($config, "UPDATE tbl_user SET username='$username', password=MD5('$password'), nama='$nama' WHERE id_user='$id_user'");
                    ...
                    <form class="col s12" method="post" action="?page=pro&sub=pass">
                        ...
                        <div class="row">
                                ...
                                <input id="username" type="text" class="validate" name="username" value="<?php echo $_SESSION['username']; ?>" required>
                                    <?php
                                        if(isset($_SESSION['epuname'])){
                                            ...
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$epuname.'</div>';
                                            unset($_SESSION['epuname']);
                                        }
                                        if(isset($_SESSION['errEpUname5'])){
                                            $errEpUname5 = $_SESSION['errEpUname5'];
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errEpUname5.'</div>';
                                ...
                                <input id="nama" type="text" class="validate" name="nama" value="<?php echo $_SESSION['nama']; ?>" required>
                                    <?php
                                        if(isset($_SESSION['epnama'])){
                                            ...
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$epnama.'</div>';
                            ...
                            <!-- <div class="input-field col s6">
                                ...
                                <input id="nip" type="text" class="validate" name="nip" value="" requigreyautocomplete="off">
                                ...
                                <input id="password" type="password" class="validate" name="password" required>
                                    <?php
                                        if(isset($_SESSION['errEpPassword5'])){
                                            ...
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errEpPassword5.'</div>';
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">looks_one</i>
                            <input id="nip" type="text" value="" readonly disable>
                            <label for="nip">NIP</label>
                        </div> -->
                    </div>
                    <!-- Row in form END -->
