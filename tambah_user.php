            ...
            <div class="row">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper pink-purple darken-1">
                            <ul class="left">
                            ...
                            <input id="username" type="text" class="validate" name="username" required>
                                <?php
                                    if(isset($_SESSION['uname'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 pink-purple lighten-4 red-text">'.$uname.'</div>';
                                        unset($_SESSION['uname']);
                                    }
                                    if(isset($_SESSION['errUsername'])){
                                        $errUsername = $_SESSION['errUsername'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 pink-purple lighten-4 red-text">'.$errUsername.'</div>';
                                        unset($_SESSION['errUsername']);
                                    }
                                    if(isset($_SESSION['errUser5'])){
                                        $errUser5 = $_SESSION['errUser5'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 pink-purple lighten-4 red-text">'.$errUser5.'</div>';
                            ...
                            <input id="nama" type="text" class="validate" name="nama" required>
                                <?php
                                    if(isset($_SESSION['namauser'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$namauser.'</div>';
                            ...
                            <input id="password" type="password" class="validate" name="password" required>
                                <?php
                                    if(isset($_SESSION['errPassword'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$errPassword.'</div>';
                            ...
                            <input id="nip" type="text" class="validate" name="nip" required>
                                <?php
                                    if(isset($_SESSION['nipuser'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$nipuser.'</div>';
                            ...
                            <div class="input-field col s11 right">
                                ...
                                <?php
                                    if(isset($_SESSION['tipeuser'])){
                                        ...
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 greylighten-4 red-text">'.$tipeuser.'</div>';
