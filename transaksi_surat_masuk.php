                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-3" id="head">
                                <tr>
                                    <th width="10%">No. Berkas<br/>No. Pakket</th>
                                    <th width="30%">Perihal<br/> File</th>
                                    <th width="14%">Alamat pengirim</th>
                                    <th width="10%">No. Petunjuk</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                  <tr>
                                    <td>'.$row['no_Berkas'].'<br/><hr/>'.$row['No. Pakket'].'</td>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-3" id="head">
                                    <tr>
                                        <th width="10%">No. Berkas<br/>No. Pakket</th>
                                        <th width="30%">Perihal<br/> File</th>
                                        <th width="24%">Alamat pengirim</th>
                                        <th width="18%">No. Surat<br/>Tgl Surat</th>
